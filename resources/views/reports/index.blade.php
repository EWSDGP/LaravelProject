                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    @forelse ($reports as $report)
                                            ...
                                            <td>
                                                <div class="d-flex gap-2 justify-content-center">
                                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                                        data-bs-target="#deleteModal{{ $report->id }}" data-bs-toggle="tooltip"
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                                        ...
                                                        {{ $report->idea->user->is_banned ? 'disabled' : '' }} data-bs-toggle="tooltip"
                                        ...
                                        <!-- Ban Modal -->
                                        <div class="modal fade" id="banModal{{ $report->idea->user->id }}" tabindex="-1" aria-labelledby="banModalLabel"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 shadow">
                                                    <div class="modal-header bg-danger text-white border-0">
                                                    ...
                                                    <div class="modal-body p-4">
                                                        <p class="mb-0">Are you sure you want to ban this user? They will no longer be able to access the
                                                            system.</p>
                                                    </div>
                                                    <div class="modal-footer border-0">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                        <form action="{{ route('manage.reports.ban', $report->idea->user->id) }}" method="POST"
                                                            class="d-inline">
                                                            @csrf
                                        ...
                                        <!-- Unban Modal -->
                                        <div class="modal fade" id="unbanModal{{ $report->idea->user->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 shadow">
                                                    ...
                                                    <div class="modal-footer border-0">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                        <form action="{{ route('manage.reports.unban', $report->idea->user->id) }}" method="POST"
                                                            class="d-inline">
                                                            @csrf
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center text-muted py-4">
                                                <i class="fas fa-info-circle me-2"></i>No reports available.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
