<div class="mobile-navigation bg-nav text-white position-fixed" style="width: 100%; z-index: 1; overflow-y: auto; height: 100vh;">
    ...
    <div class="navbar d-flex flex-column justify-content-center align-items-center fs-5">
        ...
        @else
            ...
            <li class="nav-items hover-div d-flex justify-content-center align-items-center w-100"
            style="height: 6rem">
            ...
            <div class="hover-div d-flex justify-content-center align-items-center w-100"
            style="height: 6rem">
            ...
            <div class="hover-div d-flex justify-content-center align-items-center w-100" style="height: 6rem" onclick="closeNavigation()">
